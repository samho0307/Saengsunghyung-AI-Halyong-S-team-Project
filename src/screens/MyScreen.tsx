      ...
      <SafeAreaView className="flex-1" edges={['top']}>
        <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 40 }}>
          ...
          <View className="items-center py-8 mb-4">
            <View className="w-28 h-28 rounded-full border-2 border-pink-400/50 mb-4 items-center justify-center overflow-hidden relative shadow-lg shadow-pink-500/20 bg-black/30 backdrop-blur-md">
               {generatedAvatarUrl ? (
            ...
            <View className="flex-row items-center bg-pink-500/20 border border-pink-500/30 px-3 py-1 rounded-full mt-1 backdrop-blur-sm">
               <Text className="text-pink-300 text-xs font-bold mr-1">Lv.5</Text>
               <Text className="text-pink-100 text-xs">소울메이트</Text>
            </View>
          </View>
          ...
          <View className="flex-row px-4 gap-4 mb-6">
            ...
            >
              <View className="w-10 h-10 bg-pink-500/20 rounded-full items-center justify-center mb-2">
                <Ionicons name="download" size={20} color="#F472B6" />
              </View>
            ...
            >
              <View className="w-10 h-10 bg-pink-500/20 rounded-full items-center justify-center mb-2">
                <Ionicons name="share-social" size={20} color="#F472B6" />
              </View>
          ...
          <View className="px-4 space-y-4 gap-4">
            ...
            <View className="bg-white/5 rounded-3xl overflow-hidden border border-white/10 backdrop-blur-lg">
              <View className="px-5 py-4 border-b border-white/5 bg-white/5">
                 <Text className="text-pink-300 text-xs font-bold uppercase tracking-wider">이벤트 & 퀘스트</Text>
              </View>
              <TouchableOpacity className="flex-row items-center justify-between p-5 border-b border-white/5 active:bg-white/10">
                <View className="flex-row items-center">
                  <View className="w-8 h-8 bg-yellow-500/20 rounded-full items-center justify-center mr-4">
                    <Ionicons name="trophy" size={16} color="#FBBF24" />
                  </View>
                  <Text className="text-white font-medium text-base">일일 미션</Text>
                </View>
                <View className="bg-pink-500 w-2 h-2 rounded-full shadow-pink-500 shadow-sm" />
              </TouchableOpacity>
            ...
            <View className="bg-white/5 rounded-3xl overflow-hidden border border-white/10 backdrop-blur-lg">
              <View className="px-5 py-4 border-b border-white/5 bg-white/5">
                 <Text className="text-pink-300 text-xs font-bold uppercase tracking-wider">설정</Text>
              </View>
              <TouchableOpacity className="flex-row items-center justify-between p-5 border-b border-white/5 active:bg-white/10">
                <Text className="text-white text-base pl-2">알림 설정</Text>
                <Ionicons name="toggle" size={24} color="#F472B6" />
              </TouchableOpacity>
              <TouchableOpacity className="flex-row items-center justify-between p-5 active:bg-white/10">
